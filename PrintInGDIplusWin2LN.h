...
private:
	...
	int m_position = 0;
public:
	explicit PrintInGDIplusWin2LN::PrintInGDIplusWin2LN() {

	}
	PrintInGDIplusWin2LN::~PrintInGDIplusWin2LN() {

	}
	PrintInGDIplusWin2LN::PrintInGDIplusWin2LN(PrintInGDIplusWin2LN& other) = delete;
	PrintInGDIplusWin2LN::PrintInGDIplusWin2LN(PrintInGDIplusWin2LN&& other) = delete;
	PrintInGDIplusWin2LN& operator=(const PrintInGDIplusWin2LN& other) = delete;
	PrintInGDIplusWin2LN& operator=(const PrintInGDIplusWin2LN&& other) = delete;
	
	void PrintInGDIplusWin2LN::addPrintContent(const int& p1x, const int& p1y,
